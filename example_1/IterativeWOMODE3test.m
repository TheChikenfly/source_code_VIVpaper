...
while n*dt <= finalTime 
    ...
    k = 0;
        while flag
            ...
            % Using the WOMV2
%             [cq; kq; ddZnp1; D; A; qn; dqn]
            vprvect1 = [-va 0 0]; vprvect2 = [-va 0 0];
            tl1 = [0 0 1]; tl2 = [0 0 1];
            [qnp1kp1 dqnp1] = WOMV2(vprvect1, vprvect2, [0 0 0], [0 0 ddZnp1],tl1, tl2, D, tn, dt)
            %qnp1kp1 = WOMV2(vprvect1, vprvect2, [0 0 0], [0 0 ddZnp1],tl1, tl2, D, tn, dt)
            qsol(1:2, n+1) = [qnp1kp1 dqnp1];
%             figure(6)
%             hold on
%             plot(tn, qnp1kp1,'ok');
%             hold on;
...
%                 qsol(1:2, n+1) = qnp1(end, 1:2); % The N+1 component
                  qsol(1, n+1) = qnp1kp1; % The N+1 component
            elseif k == itermax
